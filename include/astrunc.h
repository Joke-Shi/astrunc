...
namespace astrunc {
    class access {
        ...
        public :
            ...
            static int split( std::vector< std::string > &__vs, const std::string &__seg, astrunc::access::lang_t __lang, std::size_t __nchars);


        private :
            /** Split segment syntax with west langauge */
            static int split_west( std::vector< std::string > &__vs, const std::string &__seg, std::size_t __nchars);

            /** Split segment syntax with esst langauge */
            static int split_east( std::vector< std::string > &__vs, const std::string &__seg, std::size_t __nchars);

            /** Split segment syntax with armenia langauge */
            static int split_armenia( std::vector< std::string > &__vs, const std::string &__seg, std::size_t __nchars);

            /** Split segment syntax with india langauge */
            static int split_india( std::vector< std::string > &__vs, const std::string &__seg, std::size_t __nchars);
